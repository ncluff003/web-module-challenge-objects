...
const item1 = createMenuItem(`cereal`, 2, `breakfast`);
const item2 = createMenuItem(`quesodilla`, 4, `lunch`);
const item3 = createMenuItem(`hamburger`, 8, `dinner`);
...
const burger = {
  ...
  discount: function (people) {
    return people === `teacher` ? this.price * 0.75 : people === `student` ? this.price * 0.75 : this.price * 0.9;
  },
};
